...
{$REGION '  TBaseEnemy  '}
constructor TBigEnemy.CreateUnit(const APosition: TVector2F; AAngle: Single; ASide: TUnitSide);
begin
  inherited;
  FRadius := 85;
  FMass := 3;
...
begin
  ...
  if FLife < MAX_LIFE then
    TheRender.Rectangle(FPosition.X - 50, FPosition.Y - 53, FPosition.X - 50 + FLife / MAX_LIFE * 100, FPosition.Y - 50, $FF00FF00);
  TheResources.AsteroidTexture.Draw(FPosition, Vec2F(170, 170), FTowerAngle, ShieldAlpha * $1000000 + FColor - $FF000000);
end;
{$ENDREGION}
